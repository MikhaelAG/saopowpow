resource "aws_launch_template" "app1_LT" {
  ...
  user_data = base64encode(<<-EOF
    ...
    <h1>"Meanwhile, Revan..."</h1>
    <br>
    <img src = "https://media.giphy.com/media/8q92vsFOM9I2s/giphy-downsized-large.gif" alt="media.giphy.com">
    <br>
    <br>
    <img src = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExd2FuNWFsMTBmbnN6OGg5bTFoMXgxZG5ma2J0NjliZ3pyeTFyZTVmZSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l2JegPFSJ3rfxeUcU/giphy.gif" alt="media.giphy.com">
    <br>
    <h1>Revan's Reign Is No More! São Paulo Is All Ours, Sho Nuff!</h1>
    <br>
